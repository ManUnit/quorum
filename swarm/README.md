...
Building Swarm requires Go (version 1.10 or later).
    ...
    go get -d github.com/ethereum/quorum

    go install github.com/ethereum/quorum/cmd/swarm
...
You must have your working copy under `$GOPATH/src/github.com/ethereum/quorum`.
...
```
git clone git@github.com:nirname/go-ethereum.git $GOPATH/src/github.com/ethereum/quorum
```
...
```
stateth --rm --grafana-dashboards-folder $GOPATH/src/github.com/ethereum/quorum/swarm/grafana_dashboards --influxdb-database metrics
```
 ...
 * [Code review guidelines](https://github.com/ethereum/quorum/wiki/Code-Review-Guidelines).
